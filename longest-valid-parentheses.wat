(module $example.wasm
  ...
  (func $_start (type 7)
    ...
    unreachable)
  (func $longestValidParentheses (type 2) (param i32) (result i32)
  ...
  (func $__original_main (type 8) (result i32)
    ...
    local.set 15
    local.get 15
    i32.load offset=1081 align=1
    local.set 16
    local.get 2
    local.get 16
    i32.store offset=51 align=1
    local.get 15
    i32.load offset=1078 align=1
    local.set 17
    local.get 2
    local.get 17
    i32.store offset=48
